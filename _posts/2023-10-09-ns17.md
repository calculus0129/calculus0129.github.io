...
cf. Gyrus is a ridge on the cerebral cortex.
![Gyrus and Sulcus](/images/ns17_gyrus-and-sulcus.png)
...
![Alt text](/images/ns17_papez-circuit.png)
...
![Alt text](/images/ns17_Phineas-Gage.png)
...
Observations:
  ...
  3. Some activated regions are associated with more than one emotion.

Interpretations
  1. Most highly activated region uniquly represents an emotion.
   - Amygdala activity: fear;
   - Medial prefrontal activity: sadness
...
(each dimension does not carry affective weight.)
...
- Today, there is a great diversity of perspectives on the **nature of emotions**. 우리가 discussed 한 것 이외에도.
  - e.g. Antonio Damasio (at Univ. of Southern California.) investigated
    ...
    - relationship between emotion and other brain functions e.g. decision making. (Box 18.3)
...
![Figure of a monkey after temporal lobectomy](/images/ns17_temporal-lobectomy-monkey.png)

![Figure of a cat after temporal lobectomy(Supposedly)](/images/ns17_temporal-lobectomy-cat.png)
...
- Groupings: (3)
  ...
  - corticomedial nuclei
    - (cf. receive olfactory afferents)
  - central nucleus
- Inputs (various)
...
- Function
  - **Integration of information** from different sensory modalities (having different projection pattern to the amygdala nuclei)
...
![Alt text](/images/ns17_temporal-lobectomy-cat.png)
...
![Alt text](/images/ns17_learned-fear-circuit-slide.png)
...
It appears that the conditioned response in the amygdala arises from synaptic changes in the **basolateral nuclei**.

fig ![Alt text](/images/ns17_learned-fear-circuit.png)
...
![Alt text](/images/ns17_learned-fear-study.png)
